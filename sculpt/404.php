...
<div class="container" style="background-color: #FCF6EF;">
    <section class="contactTop">
        <div class="wrapper">
            ...
            <div class="titleWrapper" style="transform:translateY(50px);opacity:0;"><h1 class="largeh1">404 - page not found.</h1></div>
        </div>
    </section>
    <section class="contactPlaces">

        <div class="wrapper">
            <div style="max-width: 1000px;margin: 0 auto 180px;" class="placeWrapper">
