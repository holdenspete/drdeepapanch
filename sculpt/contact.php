...
Template name: Contact New page
  ...
  <div class="container" style="background-color: #FCF6EF;">
    ...
    <section class="contactTop">
        <div class="wrapper">
            ...
            <div class="titleWrapper" style="transform:translateY(50px);opacity:0;"><h1 class="largeh1">Address &amp; Contacts</h1></div>
        </div>
    </section>
    <section class="contactPlaces">
        <div class="wrapper">
            <div class="placeWrapper berkshire">
                <div class="leftSide" style="transform:translateX(50px);opacity:0;">
                    <div class="coinWrapper onScreen">
                        <?php $berkshire_image=get_field('berkshire_image'); ?>
                        <img class="coin" src="<?php echo $berkshire_image['sizes']['square']; ?>" width="<?php echo $berkshire_image['sizes']['square-width']; ?>" height="<?php echo $berkshire_image['sizes']['square-height']; ?>" alt="<?php echo $berkshire_image['alt']; ?>" />
                    </div>
                </div>
                <div class="rightSide" style="transform:translateX(-50px);opacity:0;">
                    <h2 class="bespokeTitle">Berkshire</h2>
                    <?php the_field('berkshire_details'); ?>
                    <div class="google">
                        <a target="_blank" href="<?php the_field('berkshire_google_link'); ?>" class="googleButton bgCream">Open in Google Maps</a>
                    </div>
                </div>
                <img class="rightShape moveLeft" src="<?php echo get_template_directory_uri(); ?>/images/contactTopShape.png" alt="Dr Deepa Panch">
                <img class="rightCloud" src="<?php echo get_template_directory_uri(); ?>/images/treatmentsCloudLeft.png" alt="Dr Deepa Panch">

            </div>
            <div class="placeWrapper london">
                <img class="leftCloud" src="<?php echo get_template_directory_uri(); ?>/images/treatmentsCloudLeft.png" alt="Dr Deepa Panch">

                <div class="leftSide">
                    <div class="coinWrapper onScreen">
                    <?php $london_image=get_field('london_image'); ?>
                        <img class="coin" src="<?php echo $london_image['sizes']['square']; ?>" width="<?php echo $london_image['sizes']['square-width']; ?>" height="<?php echo $london_image['sizes']['square-height']; ?>" alt="<?php echo $london_image['alt']; ?>" />
                    </div>
                </div>
                <div class="rightSide fadeInRight onScreen">
                    <h2 class="bespokeTitle">London</h2>
                    <?php the_field('london_details'); ?>
                    
                    <div class="google">
                        <a target="_blank" href="<?php the_field('london_google_link'); ?>" class="googleButton bgCream">Open in Google Maps</a>
                    </div>
                </div>
            </div>
            <!-- <div class="placeWrapper essex">
                <img class="rightShape moveLeft" src="<?php // echo get_template_directory_uri(); ?>/images/contactTopShape.png" alt="Dr Deepa Panch">

                <div class="leftSide">
                    <div class="coinWrapper onScreen">
                        <img class="coin" src="<?php // echo get_template_directory_uri(); ?>/images/essex.jpg" alt="Dr Deepa Panch - Berkshire">
                    </div>
                </div>
                <div class="rightSide fadeInRight onScreen">
                    <h2 class="bespokeTitle">Essex</h2>
                    <ul>
                        <li>Dr Leah Cosmetic Skin Clinic</li>
                        <li>14 York Hill, Loughton, Essex IG10 1RL</li>
                        <li><a href="tel:00442078775999">020 7877 5999</a></li>
                        <li><a href="mailto:essex@drleah.co.uk">essex@drleah.co.uk</a></li>
                        <li><a href="https://www.drleah.co.uk" target="_blank">www.drleah.co.uk</a></li>
                        <li>Tuesday</li>
                    </ul>
                    <div class="google">
                        <a target="_blank" href="https://www.google.com/maps/place/Dr+Leah+Cosmetic+Skin+Clinic/@51.6508328,0.0555331,17z/data=!3m1!4b1!4m6!3m5!1s0x47d8a1afeeac79bd:0x7cf471f719869999!8m2!3d51.6508295!4d0.0577218!16s%2Fg%2F11cn9lk108" class="googleButton bgCream">Open in Google Maps</a>
                    </div>
                </div>
            </div> -->
        </div>
